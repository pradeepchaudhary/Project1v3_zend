var lat = 28.64164161682; //default latitude
var lng = 77.18124389648; //default longitude
...
var myOptions = {
center: new google.maps.LatLng(28.64164161682,77.18124389648), //set map center
...
//***Experimental code
//var curruserid = <?php //echo $curruserid;?>
//$.post('../php_includes/save_place.php', {'place' : place, 'description' : description, 'lat' : lat, 'lng' : lng, 'userid' : curruserid},
//function(data){
//var place_id = data;
...
//);
// ****original code
$.post('../php_includes/save_place.php', {'place' : place, 'description' : description, 'lat' : lat, 'lng' : lng},
function(data){
var place_id = data;
var new_option = $('<option>').attr({'data-id' : place_id, 'data-place' : place, 'data-lat' : lat, 'data-lng' : lng, 'data-description' : description}).text(place);
new_option.appendTo($('#saved_places'));
